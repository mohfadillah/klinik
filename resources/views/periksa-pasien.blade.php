...
>
  <head>
    ...
    <title>Pendaftaran Periksa Pasien</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Klinik</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Klinik! 👋</h4>
              <p class="mb-4">Silahkan Daftar Untuk Konsultasi Kesehatan</p>

              <form id="formAuthentication" class="mb-3" action="{{route('forDaftar')}}" method="POST">
                @csrf
                <div class="mb-3">
